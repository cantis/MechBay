...
- **frontend-builder** — Specialized in building Bootstrap 5 frontends for Flask/FastAPI
- **python-flask-tester** — Writes and runs tests, ensures quality and correctness
...
**Phase 3** — Call frontend-builder to apply theme across components
**Phase 4** — Call Coder to fix any integration issues
**Phase 5** — Call python-flask-tester to write tests for any new functionality and run all tests to verify
