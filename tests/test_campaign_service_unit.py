...
def test_campaign_unit_snapshot_copies_assigned_variant(client, minimal_force):
    ...
    # Act
    campaign = campaign_service.create_campaign_from_force(minimal_force, "Variant Campaign")
...
def test_campaign_skips_variant_when_unconfigured(client, minimal_force):
    ...
    # Act
    campaign = campaign_service.create_campaign_from_force(minimal_force, "No Variant")
...
def test_campaign_independent_of_source_force(client, minimal_force):
    ...
    # Arrange
    campaign = campaign_service.create_campaign_from_force(minimal_force, "Independent")
...
def test_preferred_unit_is_convenience_only(client, minimal_force):
    ...
    # Arrange
    campaign = campaign_service.create_campaign_from_force(minimal_force, "Pilots")
...
def test_preferred_unit_must_belong_to_same_campaign(client, multiple_forces):
    ...
    # Arrange
    first = campaign_service.create_campaign_from_force(
        multiple_forces["Jade Falcon Strikers"], "One"
    )
    second = campaign_service.create_campaign_from_force(multiple_forces["Wolf Hunters"], "Two")
...
def test_opening_warchest_uses_leftover_pv(client, minimal_force):
    ...
    # Act
    campaign = campaign_service.create_campaign_from_force(minimal_force, "WP")
...
def test_opening_warchest_zero_without_budget(client, minimal_force):
    ...
    # Act
    campaign = campaign_service.create_campaign_from_force(minimal_force, "No Budget")
...
def test_opening_warchest_allows_negative(client, minimal_force):
    ...
    # Act
    campaign = campaign_service.create_campaign_from_force(minimal_force, "Over")
...
def test_campaign_month_label_without_calendar(client, minimal_force):
    ...
    # Arrange
    campaign = campaign_service.create_campaign_from_force(minimal_force, "Time")
...
def test_campaign_month_label_with_calendar(client, minimal_force):
    """Optional start month/year derives a BattleTech display date."""
    # Arrange
    campaign = campaign_service.create_campaign_from_force(
        minimal_force,
        "Calendar",
...
def test_only_one_active_campaign(client, multiple_forces):
    ...
    # Act
    second = campaign_service.create_campaign_from_force(multiple_forces["Wolf Hunters"], "Second")
...
def test_delete_miniature_blocked_in_active_campaign(client, minimal_force):
    ...
    # Arrange
    campaign = campaign_service.create_campaign_from_force(minimal_force, "Block")
...
def test_delete_miniature_from_inactive_campaign_warns(client, multiple_forces):
    ...
    second = campaign_service.create_campaign_from_force(multiple_forces["Wolf Hunters"], "Other")
    campaign_service.switch_campaign(first.id)
...
def test_new_inventory_clears_campaigns(client, minimal_force):
    ...
    # Arrange
    campaign_service.create_campaign_from_force(minimal_force, "Gone")
...
def test_create_campaign_route(client, minimal_force):
    ...
    response = client.post(
        "/campaigns/create",
        data={"name": "From Route", "force_id": str(minimal_force), "scale": "2"},
